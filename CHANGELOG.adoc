...
* *default-site-generator*: Rename Pipeline class to GeneratorContext (#860)
* *default-site-generator*: Bind the generator context to the register function of an extension unless declared as the first parameter (#860)
