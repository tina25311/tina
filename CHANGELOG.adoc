...
_No changes since previous release.
...
* *site-generator*: Detect and warn when an AsciiDoc extension is registered as an Antora extension, but do not skip it (#1141)
* Replace "AsciiDoc extension" with "Asciidoctor extension" in log messages
