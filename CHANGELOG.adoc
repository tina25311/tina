...
* *site-generator-default*: Allow extensions to replace functions on generator context (#868)
...
* *site-generator-default*: Add `GeneratorContext#getVars` method to access content variables (#813)
...
* *site-generator-default*: Rename `getVars` and `updateVars` on GeneratorContext to `getVariables` and `updateVariables`, respectively
