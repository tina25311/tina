...
* *page-composer*: Set `page.next` in UI model for component version start page if not found in navigation tree (#623)

=== Fixed

* *playbook-builder*: Replace deep-freeze-node dependency with internal implementation
* *page-composer*: `page.next` skips over reference to self (#622)
