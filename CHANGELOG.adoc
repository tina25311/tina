...
* *content-aggregator*: Add full support for resolving symlinks in the git tree (#188)
* *content-aggregator*: Allow playbook or component descriptor to configure version for content source to be derived from refname (#296)
* *content-aggregator*: Allow playbook to define version for content source (#296)

=== Fixed

* *content-aggregator*: Add full support for resolving symlinks that originate from the worktree; enable symlink tests on Windows (#747)
* *content-aggregator*: Provide clearer error message when broken symlink or symlink cycle is detected in worktree (#747)
