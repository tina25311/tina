...
* *site-generator-default*: Append /index.html to file URI in completion status message if site start page is defined (#889)
* *site-generator-default*: Reword completion status message (#889)
