...
* *content-aggregator*: Switch back to using versionless cache folder inside cache directory for content repositories (#690)
...
* Drop support for Node.js 8 and set minimum required version to 10 (#679)
