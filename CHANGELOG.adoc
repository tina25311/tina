...
* *playbook-builder*: Further restrict type of runtime.log.destination.buffer_size in playbook schema from number to integer
* *content-aggregator*: Switch back to versionless default cache folder for content repositories (#690)
