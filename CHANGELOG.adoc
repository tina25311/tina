...
* *site-generator*: Integrate HTML parser into Antora runtime by adding polyfill for top-level DOMParser class (#1120)
* *site-generator*: Add parseHTML helper method to generator context that parses HTML from string using DOMParser (#1120)
