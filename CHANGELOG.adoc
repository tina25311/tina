...
* *playbook-builder*: Allow custom site generator to be configured in playbook using `pipeline.generator` key (#857)
* *playbook-builder*: Export default configuration schema as `defaultSchema` property (#857)
* *cli*: If site generator accepts a single parameter, build playbook in CLI and pass to site generator (#857)
