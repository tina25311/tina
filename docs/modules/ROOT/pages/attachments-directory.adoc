...
A module directory can contain an optional xref:family-directories.adoc[family directory] named [.path]_attachments_.
...
Attachments are stored in an [.path]_attachments_ directory.
