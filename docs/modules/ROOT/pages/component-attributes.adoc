...
Check out the xref:page:intrinsic-attributes.adoc[intrinsic attribute reference] for a complete list of the `page-` attributes Antora automatically declares.
