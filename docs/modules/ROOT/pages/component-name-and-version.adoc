...
If you are defining multiple versions of a component, be sure to always use the same case when declaring the component name.
If the case differs (e.g., Silver-Leaf vs silver-leaf), Antora will treat these as different components, not different versions of the same component.
