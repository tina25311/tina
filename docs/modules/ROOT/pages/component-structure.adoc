...
All the sources associated with these [.path]_antora.yml_ files are added to the content catalog and included in the component version.
...
Results of conflicting or duplicate metadata may be unpredictable.
