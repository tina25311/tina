...
Not only does the plugin assist with writing and previewing content in AsciiDoc, it also provides state of the art assistance for configuring Antora and for creating and validating references.
