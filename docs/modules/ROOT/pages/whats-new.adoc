...
_**Release date:** 2021.12.21 | *Issue label:* {url-milestone-3-0-0}[3.0.0^]_
...
Antora 2 does not honor the `http_proxy` and `https_proxy` environment variables, whereas Antora 3 does.
