...
. The next page was not being set for the component version start page if the start page is not present in the navigation tree (and, conversely, the previous page was not being set to the component version start page for the first page in the navigation tree).
