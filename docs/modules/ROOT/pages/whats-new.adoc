...
Issue {url-issues}/779[#779^]:: Add `git.fetch_concurrency` key to playbook to control the maximum number of fetch or clone operations that are permitted to run at once.
