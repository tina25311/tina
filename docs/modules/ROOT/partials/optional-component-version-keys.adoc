...
The key-value pairs listed under `attributes` represent built-in and user-defined xref:page:asciidoc-attributes.adoc[AsciiDoc attributes] (e.g., `idseparator: '-'`) and xref:page:page-attributes.adoc[page attributes].
