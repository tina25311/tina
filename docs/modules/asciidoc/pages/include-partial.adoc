...
A partial can be inserted into any page in your documentation site using the include directive and the partial file's resource ID.

== AsciiDoc include directive

Let's break down the AsciiDoc syntax and resource ID coordinates you need to include a partial into a page.
...
The brackets can contain an optional list of attributes such as `leveloffset`, `lines`, and `tags`.
