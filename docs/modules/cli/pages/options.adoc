...
A function must start with the xref:index.adoc#run-cli-commands[antora base command] and end with the xref:index.adoc#specify-playbook[playbook file argument].
