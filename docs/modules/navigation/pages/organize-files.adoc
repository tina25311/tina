...
You just need to xref:page:module-and-page-xrefs.adoc#xref-page-across-modules[add the module coordinate] (or xref:page:module-and-page-xrefs.adoc#component-versions[component name and version coordinates]) to the cross references you create in the navigation file.
