...
You can see another example of a custom attribute being used to replace a complex URL in xref:asciidoc:external-urls.adoc#create-page-attribute[Create an attribute for a URL].
