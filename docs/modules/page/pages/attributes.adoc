...
TIP: Attributes can also be xref:ROOT:component-attributes.adoc[scoped to a component version] or xref:playbook:asciidoc-attributes.adoc[scoped to a whole site].
