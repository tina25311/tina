...
The following steps assume that the target {family} and xref:resource-id-coordinates.adoc#current[current page] belong to the same component version and module.
