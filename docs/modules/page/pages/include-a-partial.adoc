...
When the target partial file and the current page belong to different modules of the same component version, enter the partial's module, family, and resource coordinates in the resource ID.
...
When the target partial file and the current page belong to different docs components, enter the partial's version, component, module, family, and resource coordinates in the resource ID.
