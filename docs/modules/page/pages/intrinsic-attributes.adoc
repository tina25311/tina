...
:page-aliases: page:page-and-site-attributes.adoc,ROOT:environment-and-page-attributes.adoc
...
We refer to these as [.term]_intrinsic attributes_.
...
Intrinsic attributes differ from predefined page attributes, such as xref:page-aliases.adoc[`page-aliases`], in that predefined page attributes are meant to be a conduit to pass information to Antora from the page.
*Intrinsic attributes are intended to be read only and should therefore not be reassigned.*
...
They can be reconfigured using the playbook.

Antora also passed down some information about the site using document attributes.
...
=== Putting intrinsic page attributes to work
