...
xref:module-and-page-xrefs.adoc[Xref pages in the same component version] has several examples showing how to create xrefs to pages that belong to the same module or component version.
For xref examples where the target and current pages belong to different components or different versions of the same component, see xref:version-and-component-xrefs.adoc[Xref pages in other components and versions].
