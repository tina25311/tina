...
When you change the content in a partial, those changes will disseminate to all of the pages where you embedded that partial with an xref:asciidoc:include-partial.adoc[AsciiDoc include directive].
