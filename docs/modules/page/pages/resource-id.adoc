...
See xref:asciidoc:include-example.adoc[Include an example].
...
See xref:asciidoc:include-page.adoc[Include a page].

|xref:partials-and-content-snippets.adoc[Partials]
|`include::resource-id[]`
|*The `partial$` coordinate is required* in the target value.
See xref:asciidoc:include-partial.adoc[Include a partial].
|===
