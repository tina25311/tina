...
When the xref:page-id.adoc#target[current and target] pages belong to different docs components, you must, at a minimum, specify the target page's xref:resource-id-coordinates.adoc#id-component[component, module, and file coordinates].
