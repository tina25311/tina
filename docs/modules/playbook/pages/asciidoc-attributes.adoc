...
Any xref:playbook:asciidoc-attributes.adoc[site attribute] already set can be referenced from the value of another site attribute using the attribute reference syntax (e.g., `+http://localhost:9090/{db}+`).
