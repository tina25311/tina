...
By default, Antora automatically appends [.path]_.git_ to remote repository URLs when it's missing.
You can control this behavior with the xref:git-suffix.adoc[ensure_git_suffix key].
