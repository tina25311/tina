...
* [x] What xref:asciidoc-attributes.adoc[AsciiDoc and Antora page attributes] and xref:asciidoc-extensions.adoc[Asciidoctor extensions] should be applied site wide.
