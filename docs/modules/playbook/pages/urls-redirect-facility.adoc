...
gitlab::
A redirect file for GitLab Pages is generated and placed at the root of the generated site at [.path]_+++_redirects+++_.
netlify::
A redirect file for Netlify is generated and placed at the root of the generated site at [.path]_+++_redirects+++_.
nginx::
A redirect file for nginx is generated and placed at the root of the generated site at [.path]_.etc/nginx/rewrite.conf_.
nginx will not know to look for the file in this location, so you will either need to move it or configure nginx to use it.
[[static-value]]static::
