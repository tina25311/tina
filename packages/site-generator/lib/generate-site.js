...
async function generateSite (playbook) {
  ...
  try {
    ...
    vars.pageComposer = fxns.createPageComposer(playbook, contentCatalog, uiCatalog, playbook.env)
    await context.notify('pageComposerCreated')
