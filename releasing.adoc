...
* https://gitlab.com/antora/antora/blob/master/scripts/preversion.js[preversion.js]
...
In the *preversion* script, the copyright year is updated in the [.path]_README.adoc_.
